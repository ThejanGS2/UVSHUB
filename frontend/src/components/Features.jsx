    ...
    <section className="features" id="approach" aria-labelledby="features-heading">
      <div className="features__inner">
        ...
        <div className="bento">
          ...
          <div className="bento-cell bento-cell--c8 bento-cell--r2 bento-cell--glow-violet">
          ...
          {/* Stat — Students */}
          <div className="bento-cell bento-cell--c4 bento-cell--glow-accent">
          ...
          {/* Learning progress */}
          <div className="bento-cell bento-cell--c4">
          ...
          {/* Categories */}
          <div className="bento-cell bento-cell--c4 bento-cell--glow-blue">
            <div className="bento-cell__icon" style={{ color: 'var(--blue)' }}>
